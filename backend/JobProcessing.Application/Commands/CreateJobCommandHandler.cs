...
namespace JobProcessing.Application.Commands
{
    public class CreateJobCommandHandler : IRequestHandler<CreateJobCommand, int>
    {
        ...
        public async Task<int> Handle(CreateJobCommand request, CancellationToken cancellationToken)
        {
            ...
            var job = new Job(request.Name, request.Description, request.HighlightedDescription, jobLocation, request.NumberOfEmployeesRequired, request.JobDurationType, price, request.Urgency, request.UserId, request.CategoryId);
